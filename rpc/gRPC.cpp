...
namespace QtGrpc {
    ...
    private:
        ...
        QNetworkReply *post(const QString &method, const QString &service, const QByteArray &args) {
            ...
            request.setRawHeader("nekoray_auth", nekoslop_auth);
    ...
    public:
        Http2GrpcChannelPrivate(const QString &url_, const QString &nekoslop_auth_, const QString &serviceName_) {
            url_base = "http://" + url_;
            nekoslop_auth = nekoslop_auth_.toLatin1();
