...
This needs to be run NekoSlop with administrator privileges.</source>
        <translation>Добавить inbound c Tun в конфигурацию профиля вместо того, чтобы использовать два отдельных процесса.
Для этого необходимо запускать NekoSlop c правами администратора.</translation>
    </message>
    <message>
    ...
    <message>
        <source>Whether blacklisted or whitelisted, your traffic will be handled by nekoslop_core (sing-tun). This is NOT equal to &quot;process mode&quot; of some software.</source>
        <translation>При использовании белого или черного списка, ваш трафик будет обработан ядром nekoslop (sign-tun). Это НЕ эквивалент &quot;process mode&quot; как в некотором ПО.</translation>
    </message>
    <message>
    ...
    <message>
        <source>If you have trouble starting VPN, you can force reset nekoslop_core process here.

If still not working, see documentation for more information.
https://matsuridayo.github.io/n-configuration/#vpn-tun</source>
        <translation>Если у вас проблемы с запуском VPN, можно принудительно перезапустить процесс nekoslop-core.
...
<context>
    ...
    <message>
        <source>Please run NekoSlop as admin</source>
        <translation>Пожалуйста, запустите NekoSlop с правами администратора</translation>
    </message>
    <message>
