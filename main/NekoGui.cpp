...
namespace NekoGui {
    ...
    QString FindCoreAsset(const QString &name) {
        ...
        search << "/usr/lib/nekoslop";
        search << "/usr/share/nekoslop";
    ...
    QString FindNekoSlopCoreRealPath() {
        auto fn = QApplication::applicationDirPath() + "/nekoslop_core";
...
#else
#ifdef Q_OS_LINUX
        admin |= Linux_GetCapString(FindNekoSlopCoreRealPath()).contains("cap_net_admin");
#endif
        admin |= geteuid() == 0;
#endif
